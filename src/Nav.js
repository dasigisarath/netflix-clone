...
function Nav() {
  ...
  return (
    <div className={`nav ${show && "nav__black"}`}>
      <img
        className="nav__logo"
        src="https://lh3.googleusercontent.com/proxy/K3VDKUAlyOVzEZxTDbmOv2cSrt3L8aag2G57kluL-h625uDqQ7F6a9aQZHDk-dJzKPFHZufBNKeprOwGAhWPMs2PhqoC1OV2Vt0jmZsy61z4EIjuVeI"
        alt="Nettflix Logo"
      />
      <img
